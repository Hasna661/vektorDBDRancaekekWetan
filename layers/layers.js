...
jsonSource_UTMVEKTORwaypoints_3.addFeatures(features_UTMVEKTORwaypoints_3);cluster_UTMVEKTORwaypoints_3 = new ol.source.Cluster({
  distance: 10,
  source: jsonSource_UTMVEKTORwaypoints_3
});
var lyr_UTMVEKTORwaypoints_3 = new ol.layer.Vector({
                declutter: false,
                source:cluster_UTMVEKTORwaypoints_3, 
...
lyr_UTMVEKTORwaypoints_3.set('fieldAliases', {'Name': 'Name', 'timestamp': 'timestamp', });
...
lyr_UTMVEKTORwaypoints_3.set('fieldImages', {'Name': 'TextEdit', 'timestamp': 'DateTime', });
...
lyr_UTMVEKTORwaypoints_3.set('fieldLabels', {'Name': 'no label', 'timestamp': 'no label', });
